...
This project predicts whether a customer is likely to churn based on customer profile, billing

details, and service information. It is built as an end-to-end machine learning project with Streamlit app for live predictions.
